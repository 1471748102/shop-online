    ...
    <div class="content-box w">
        <div class="login-box">
            ...
            <div class="login-div2">
                <p>
                    <a href="index2.jsp"/>管理员登陆</a>
                    <span>|</span>
                    <a href="index.jsp" class="active">会员登录</a>
                </p>
            </div>
            <div class="login-div3">
                <s:form action="Check" method="post">
                <label for="username" class="user"></label><s:textfield id="username" name="username" type="text" class="no-border-left" placeholder="用户名" theme="simple"/>
                <label for="password" class="pwd"></label><s:textfield id="password" name="password" type="password" class="no-border-left" placeholder="密码" theme="simple"/>
                <a href="LossMima.jsp" class="clearfix">忘记密码</a>
                    <button>登录</button>
                </s:form>
                <s:fielderror name="uka"></s:fielderror>
            </div>
            <div class="login-div4">
                <a href="Tel/QQ.jsp"><i class="qq"></i>QQ</a>
                <span>|</span>
                <a href="Tel/WeChat.jsp"><i class="weixin"></i>微信</a>
                <a href="zhuce.jsp" class="register"><i class="register-icon"></i>立即注册</a>
